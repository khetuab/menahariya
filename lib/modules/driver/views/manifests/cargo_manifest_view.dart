...
class CargoManifestView extends GetView<CargoListController> {
  ...
  Widget _buildCargoCard(BuildContext context, CargoModel cargo) {
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppDimens.margin8),
          Text(
            'This trip has no cargo assigned',
